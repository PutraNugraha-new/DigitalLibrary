		...
		<div class="md-9 sm-9 col">
			...
			<form action="anggota_simpan.php" method="POST">
				<div class="row form-group flex-middle">
					...
					<div class="col-2">
						<input type="text" maxlength="5" name="nia" placeholder="NIA anggota" class="input-block" required>
					</div>
				</div>
				<div class="row form-group flex-middle">
					<div class="col-3">
				...
				<div class="row form-group flex-middle">
					...
					<div class="col-4">
						<input type="text" maxlength="13" name="ponsel" placeholder="Nomor ponsel" class="input-block" required>
					</div>
				</div>
				<div class="row form-group flex-middle">
					<div class="col-3">
